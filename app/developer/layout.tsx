          ...
          <div className="absolute top-[60px] left-3 right-3 bottom-3 bg-[#0f1116]/95 border border-white/10 rounded-3xl shadow-2xl overflow-y-auto p-4">
            ...
            <div className="mt-4 pt-4 border-t border-white/10 space-y-1">
              <Link
                href="/dashboard"
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all"
              >
        ...
        <div className="border-t border-white/8 p-3 space-y-2">
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-white/5 border border-white/5 text-xs text-white/50 hover:text-white hover:bg-white/8 transition-all"
            >
