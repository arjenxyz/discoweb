...
export default function DiscordRolePreview({
  ...
  return (
    <div className="space-y-3">
      <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Discord önizleme</p>
        ...
        <div className="px-3 py-3">
          <div className="flex gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-[#dbdee1]">Çekilişi kazandım!</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {showHierarchyWarning && (
        <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 px-3 py-2.5 text-xs leading-relaxed text-amber-200/90">
          <strong className="text-amber-300">Önemli:</strong> Yeni roller genelde listenin en altında oluşur.
          Rol ikonu görünmüyorsa, Discord sunucu ayarlarından rolü bot rolünün üstüne taşıyın.
        </div>
      )}
    </div>
  );
